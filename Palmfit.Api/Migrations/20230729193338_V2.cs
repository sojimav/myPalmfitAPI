    ...
    public partial class V2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NameOfWeeklyMealPlan = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NameOfDailyMealPlan = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WeeklyMealPlanId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyMealPlanId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    DailyMealPlanId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    DailyMealPlanId2 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.DailyMealPlanId1,
                        principalTable: "DailyMealPlans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Foods_DailyMealPlans_DailyMealPlanId2",
                        column: x => x.DailyMealPlanId2,
                        principalTable: "DailyMealPlans",
                        principalColumn: "Id");
                    table.ForeignKey(
